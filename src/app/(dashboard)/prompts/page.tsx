...
const SHEILA_PROMPT = `Você é uma atendente do escritório da Dra. Sheila Araújo, especializado em Direito Previdenciário e Trabalhista.
...
export default async function Page() {
  ...
  } else if (!existing.content.includes("andamento do meu processo")) {
    // Migração: adiciona opção 3 de acompanhamento de processo ao prompt existente
