    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="text-xs text-gray-400 mb-2">
          Digite esta palavra no WhatsApp para parar a IA e assumir a conversa. Use <span className="font-mono bg-gray-100 px-1 rounded">#</span> para parar e <span className="font-mono bg-gray-100 px-1 rounded">.</span> para retomar a qualquer momento.
        </p>
      ...
      <div className="rounded-lg bg-indigo-50 border border-indigo-100 p-3 space-y-1">
        ...
        <div className="flex flex-col gap-0.5">
          <p className="text-xs text-indigo-600"><span className="font-mono font-bold">#</span> — Para a IA imediatamente</p>
          <p className="text-xs text-indigo-600"><span className="font-mono font-bold">.</span> — Retoma a IA</p>
          {keyword.trim() && (
