...
- Se o humano já coletou alguma informação (nome, e-mail, área), considere essa informação como disponível e não repita a pergunta.`
  ...
  const triageStateSection = triageState
    ? `\n\n--- ESTADO DA TRIAGEM (extraído automaticamente desta conversa) ---\n${triageState}\n- Todo item marcado como "JÁ COLETADO" está respondido: é PROIBIDO perguntá-lo novamente.\n- Pergunte apenas o primeiro item marcado como "FALTA".\n- Enquanto houver item marcado como "FALTA", é PROIBIDO encaminhar o contato para a Dra. Sheila sem triar — continue a triagem.\n\nSE NADA ESTIVER MARCADO COMO "FALTA" (triagem já concluída antes):\n- A triagem desta pessoa JÁ TERMINOU. Não recomece o fluxo, não repita a mensagem de encerramento e não peça dados de novo.\n- Se ela apenas cumprimentar ("oi", "olá", "bom dia", "tudo bem?"), responda em UMA frase curta usando o primeiro nome dela e pergunte de forma DIRECIONADA se o contato é sobre o caso que já está registrado ou sobre um assunto novo. Exemplo: "Olá, [nome]! É sobre o caso que já registramos aqui ou sobre outro assunto?"\n- É PROIBIDO responder com "Como você está?", "Como posso ajudar?", "Em que posso assisti-lo?" ou qualquer pergunta aberta sem direção.\n- Se ela trouxer um assunto novo dentro do escopo, colete só o que faltar desse assunto novo.\n- Se ela pedir posição/andamento do caso, diga que a equipe está com o caso e vai retornar pelo WhatsApp, e inclua [TRANSFERIR_PARA_HUMANO] no final.`
    : "";
